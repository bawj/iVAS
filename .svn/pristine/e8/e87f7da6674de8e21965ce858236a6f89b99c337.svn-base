...
public class AmountUtil {
    ...
    public static Integer add(Integer val1, Integer val2, int scale) {
        if (null == val1) {
            val1 = Integer.valueOf(String.valueOf(0));
        }
        if (null == val2) {
            val2 = Integer.valueOf(String.valueOf(0));
        }
        return new BigDecimal(Integer.toString(val1)).add(new BigDecimal(Integer.toString(val2))).setScale(scale, BigDecimal.ROUND_HALF_UP).intValue();
    }
     ...
     * @return double
     */
    public static Float subtract(Float val1, Float val2, int scale) {
        if (null == val1) {
            val1 = 0f;
        }
        if (null == val2) {
        ...
        return new BigDecimal(Double.toString(val1)).subtract(new BigDecimal(Double.toString(val2))).setScale(scale, BigDecimal.ROUND_HALF_UP).floatValue();
    }
